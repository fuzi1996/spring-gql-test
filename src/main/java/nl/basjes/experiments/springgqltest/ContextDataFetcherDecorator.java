...
final class ContextDataFetcherDecorator implements DataFetcher<Object> {
    ...
    public Object get(DataFetchingEnvironment environment) throws Exception {
        ...
        ContextView contextView = ExceptionResolversExceptionHandler
            .getReactorContext(environment.getGraphQlContext());

        if (this.subscription) {
            return (!contextView.isEmpty() ? Flux.from((Publisher<?>) value)
                .contextWrite(contextView) : value);
        }
    ...
    static GraphQLTypeVisitor TYPE_VISITOR = new GraphQLTypeVisitorStub() {
        ...
        public TraversalControl visitGraphQLFieldDefinition(GraphQLFieldDefinition fieldDefinition,
            ...
            GraphQLCodeRegistry.Builder codeRegistry = context
                .getVarFromParents(GraphQLCodeRegistry.Builder.class);
